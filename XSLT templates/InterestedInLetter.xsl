		...
		<xsl:call-template name="generalStyle" />
			...
			<xsl:attribute name="style">
				...
				<table cellspacing="0" cellpadding="5" border="0">
                                <tr><td colspan="2"><br/><!-- @@You_were_specify@@<br/> -->

We are pleased to inform you that an item of interest has arrived in the Library’s Acquisitions &amp; Eresources Department.  For online materials, you may click on the MMS ID link below to access the title. For physical titles, additional processing may be required before it is available for checkout.  If it is needed urgently, please request it by clicking on the MMS ID link, sign into the Library Catalog, and select from the available options.

                                        </td></tr>
				<tr>
					<td><br />@@orderNumber@@:<br /></td>
					<td><br /><xsl:value-of  select="notification_data/line_number"/><br /></td>
				</tr>
				<tr>
					<td><br />@@title@@:<br /></td>
