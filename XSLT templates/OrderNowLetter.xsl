          ...
          <div class="messageBody">
            <table cellspacing="0" cellpadding="5" border="0">
				<tr>
                    ...
                    <br/><b>Publisher: </b><xsl:value-of select="notification_data/publication_place" /> &#160;<xsl:value-of select="notification_data/publisher" /> &#160;<xsl:value-of select="notification_data/publication_date" />
					</td>
				</tr>
					<tr>
					<td>
